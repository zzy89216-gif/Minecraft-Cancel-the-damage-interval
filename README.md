...
在当前实现中，CTDI 针对无敌帧与攻击冷却相关逻辑进行修改，使连续攻击不再受到这两项原版机制的限制。
...
前往项目的 [Releases](https://github.com/zzy89216-gif/Minecraft-Cancel-the-damage-interval/releases) 页面，根据你的 Minecraft 版本选择对应的 CTDI Release。
...
> 如果 Minecraft 版本、Mod Loader 或 Java Runtime 与 CTDI Release 不匹配，可能导致模组无法加载、启动失败或出现兼容性问题。
>
> 请优先使用与 Release 标注完全一致的运行环境。
...
具体行为可能因 Minecraft 版本与 Mod Loader 实现差异而有所不同。
...
| 方向 | 内容 | 状态 |
|:---|:---|:---:|
| **核心战斗机制** | 无敌帧与攻击冷却处理 | ✅ 已实现 |
| **配置系统** | 提供可配置的战斗机制 | 📋 规划 |
| **实体白名单** | 针对特定实体恢复原版行为 | 📋 规划 |
| **网络优化** | 改善多人环境下的战斗体验 | 📋 规划 |
| **Minecraft 多版本** | 扩展不同 Minecraft 版本 | 🔮 持续适配 |
| **Forge** | Forge 版本适配 | 🔮 持续适配 |
| **Fabric** | Fabric 版本适配 | 📋 规划 |
| **NeoForge** | NeoForge 版本适配 | 📋 规划 |
| **Quilt** | Quilt 版本适配 | 📋 规划 |
| **Java 8** | Java 8 Runtime 适配 | 🔮 |
| **Java 17** | Java 17 Runtime 适配 | 🔮 |
| **Java 21** | Java 21 Runtime 适配 | 🔮 |
| **Java 25** | Java 25 Runtime 适配 | 🔮 |
